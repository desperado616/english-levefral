...
// Customer review slider section with rating.
// Customer photos replaced with a styled circular placeholder.
...
const testimonials: Testimonial[] = [
  {
    ...
    name: "Kirill",
    city: "from Telegram",
    text: "I bought LV from Lefevralov Store. Thank you very much for the excellent quality and price. Fast shipping. I highly recommend this store. Paid via PayPal, no issues at all.",
    rating: 5
  },
  {
    id: 2,
    name: "Lena",
    city: "from Avito",
    text: "I would like to thank the seller for their responsiveness and quick shipping. I am very satisfied with the bag. I highly recommend this seller!",
    rating: 5
  },
  {
    id: 3,
    name: "Dima",
    city: "from Telegram",
    text: "I ordered with prepayment. The seller promptly helped me choose the right size and shipped quickly. The polo shirt is excellent. I will definitely order again.",
    rating: 5
  }
];
        ...
        <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
          <div className="-rotate-[2.2deg]">
            ...
            <p className="section-subtitle">
              We value personal communication and customer trust, which is why we pay great
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="mt-6 flex flex-wrap items-center gap-4">
                  ...
                  <div
                    aria-label={`Rating ${current.rating} out of 5`}
