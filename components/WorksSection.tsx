...
// Catalog section with a 3x3 product card grid.

import Image from "next/image";
import { motion } from "framer-motion";

const works = [
  { name: "Louis Vuitton Trainer", size: "Size 43", price: "19 900 ₽", image: "/products/1.jpg" },
  { name: "Jimmy Choo High Top", size: "Size 42, 27 cm", price: "10 990 ₽", image: "/products/2.jpg" },
  { name: "Dolce&Gabbana", size: "Size S-M", price: "8 790 ₽", image: "/products/3.jpg" },
  { name: "Adidas Jeremy Scott", size: "Size 40", price: "7 790 ₽", image: "/products/4.jpg" },
  { name: "Dolce&Gabbana", size: "Size M", price: "18 990 ₽", image: "/products/5.jpg" },
  { name: "Versace", size: "Size 41, 26 cm", price: "7 090 ₽", image: "/products/6.jpg" },
  { name: "Gosha Rubchinskiy", size: "Size M", price: "5 890 ₽", image: "/products/7.jpg" },
  { name: "Dolce&Gabbana Cap", size: "Size Unisex", price: "3 190 ₽", image: "/products/8.jpg" },
  { name: "Louis Vuitton Frontrow Red", size: "Size 41.5, 26.5 cm insole", price: "12 990 ₽", image: "/products/9.jpg" }
];
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
        ...
        <p className="text-sm text-gray-400 rotate-[0.5deg]">*Please contact the store owner for availability and new drops.</p>
      </div>
        ...
        {works.map((work, index) => {
          ...
          return (
            ...
            <div className="relative h-64 w-full overflow-hidden rounded-t-2xl bg-slate-900">
              ...
              <span className="absolute left-4 top-4 flex h-7 w-7 items-center justify-center rounded-full border border-white/20 bg-black/50 text-[10px] font-bold text-brand-gold" aria-label={`Item ${index + 1}`}>{index + 1}</span>
            ...
            <div className="relative flex flex-1 flex-col justify-between p-5 sm:p-6">
              ...
              <p className="mt-4 text-xs font-medium uppercase tracking-[0.2em] text-brand-gold/80">Check availability with the owner</p>
