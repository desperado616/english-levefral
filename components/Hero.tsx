      ...
      <div className="relative section-container flex min-h-screen flex-col items-center justify-center pt-4 sm:pt-28 pb-8">
        ...
        >
          ...
          <p className="mx-auto max-w-xl text-sm sm:text-base text-gray-200/90">
            Premium luxury streetwear at the best prices.
          </p>

          <div className="flex flex-wrap items-center justify-center gap-4 pt-6">
            <Link
              href="#catalog"
              className="group relative inline-flex min-h-[44px] min-w-[44px] items-center justify-center overflow-hidden rounded-full bg-[#ff6b35] px-8 py-3 text-sm sm:text-base font-semibold text-slate-950 shadow-lg shadow-black/40 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-[#ff6b35]/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#ff6b35] focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950"
            >
